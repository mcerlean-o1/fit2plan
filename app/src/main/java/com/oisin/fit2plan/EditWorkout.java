...
public class EditWorkout extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtSave.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Workout workout = new Workout(edtDate.getText().toString(), edtA1.getText().toString(), edtA2.getText().toString(), edtB1.getText().toString(), edtB2.getText().toString(), edtC1.getText().toString(), edtC2.getText().toString(), edtMultiNotes.getText().toString());
